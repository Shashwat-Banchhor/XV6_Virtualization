...
000039b2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
    39b2:	b8 25 00 00 00       	mov    $0x25,%eax
    39b7:	cd 40                	int    $0x40
    39b9:	c3                   	ret    

000039ba <scheduler_log_on>:
SYSCALL(scheduler_log_on)
    39ba:	b8 24 00 00 00       	mov    $0x24,%eax
    39bf:	cd 40                	int    $0x40
    39c1:	c3                   	ret    
