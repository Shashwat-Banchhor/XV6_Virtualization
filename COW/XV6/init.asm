...
00000452 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 452:	b8 25 00 00 00       	mov    $0x25,%eax
 457:	cd 40                	int    $0x40
 459:	c3                   	ret    

0000045a <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 45a:	b8 24 00 00 00       	mov    $0x24,%eax
 45f:	cd 40                	int    $0x40
 461:	c3                   	ret    
