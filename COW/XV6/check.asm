...
main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    ...
    // printf(1,"%d and destroy it %d \n",a , 6 );
   	int b = getcid();
  11:	e8 64 03 00 00       	call   37a <getcid>
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c5 07 00 00       	mov    $0x7c5,%ebx
        while(*s != 0){
 ...
 621:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 78 0a 00 00    	cmp    %eax,0xa78
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 ...
 777:	0a 00 00 
 77a:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 789:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 790:	00 00 00 
