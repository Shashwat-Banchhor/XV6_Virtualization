...
00000e22 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
     e22:	b8 25 00 00 00       	mov    $0x25,%eax
     e27:	cd 40                	int    $0x40
     e29:	c3                   	ret    

00000e2a <scheduler_log_on>:
SYSCALL(scheduler_log_on)
     e2a:	b8 24 00 00 00       	mov    $0x24,%eax
     e2f:	cd 40                	int    $0x40
     e31:	c3                   	ret    
