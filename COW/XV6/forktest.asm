...
000004b2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 4b2:	b8 25 00 00 00       	mov    $0x25,%eax
 4b7:	cd 40                	int    $0x40
 4b9:	c3                   	ret    

000004ba <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 4ba:	b8 24 00 00 00       	mov    $0x24,%eax
 4bf:	cd 40                	int    $0x40
 4c1:	c3                   	ret    
