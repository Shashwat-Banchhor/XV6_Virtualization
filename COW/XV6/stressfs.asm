...
000004a2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 4a2:	b8 25 00 00 00       	mov    $0x25,%eax
 4a7:	cd 40                	int    $0x40
 4a9:	c3                   	ret    

000004aa <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 4aa:	b8 24 00 00 00       	mov    $0x24,%eax
 4af:	cd 40                	int    $0x40
 4b1:	c3                   	ret    
