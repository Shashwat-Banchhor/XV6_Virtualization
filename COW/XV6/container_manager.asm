...
_container_manager:     file format elf32-i386
...
main(int argc, char **argv)
{
  ...
  1d:	68 ca 07 00 00       	push   $0x7ca
  22:	6a 01                	push   $0x1
  24:	e8 37 04 00 00       	call   460 <printf>
	sleep(10);
  29:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  30:	e8 ed 02 00 00       	call   322 <sleep>
...
000003a2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 3a2:	b8 25 00 00 00       	mov    $0x25,%eax
 3a7:	cd 40                	int    $0x40
 3a9:	c3                   	ret    

000003aa <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 3aa:	b8 24 00 00 00       	mov    $0x24,%eax
 3af:	cd 40                	int    $0x40
 3b1:	c3                   	ret    
