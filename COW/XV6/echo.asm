...
000003d2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 3d2:	b8 25 00 00 00       	mov    $0x25,%eax
 3d7:	cd 40                	int    $0x40
 3d9:	c3                   	ret    

000003da <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 3da:	b8 24 00 00 00       	mov    $0x24,%eax
 3df:	cd 40                	int    $0x40
 3e1:	c3                   	ret    
