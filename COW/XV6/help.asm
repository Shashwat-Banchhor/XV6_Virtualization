...
main(int argc, char **argv )
{
  ...
  11:	8b 41 04             	mov    0x4(%ecx),%eax
    printf(1,"This is for working by %s\n",argv[0] );
  14:	ff 30                	pushl  (%eax)
  16:	68 a8 07 00 00       	push   $0x7a8
  1b:	6a 01                	push   $0x1
  1d:	e8 2e 04 00 00       	call   450 <printf>
    exit();
...
00000392 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 392:	b8 25 00 00 00       	mov    $0x25,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    

0000039a <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 39a:	b8 24 00 00 00       	mov    $0x24,%eax
 39f:	cd 40                	int    $0x40
 3a1:	c3                   	ret    
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c3 07 00 00       	mov    $0x7c3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 70 0a 00 00       	mov    %eax,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 70 0a 00 00    	mov    0xa70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 ...
 777:	0a 00 00 
 77a:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 74 0a 00 00       	mov    $0xa74,%eax
 789:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 790:	00 00 00 
