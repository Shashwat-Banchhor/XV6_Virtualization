...
_container_check:     file format elf32-i386
...
main(void)
{
  ...
  12:	6a 07                	push   $0x7
  14:	e8 91 04 00 00       	call   4aa <create_container>
  19:	89 c3                	mov    %eax,%ebx
        create_container(6);
  1b:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  22:	e8 83 04 00 00       	call   4aa <create_container>
  ...
  39:	e8 8c 03 00 00       	call   3ca <fork>
    if(pid==0){
  3e:	85 c0                	test   %eax,%eax
  40:	0f 85 ae 00 00 00    	jne    f4 <main+0xf4>

        // exec("container_manager", &arg);
        printf(1,"%s\n","I am Child" );
  46:	50                   	push   %eax
  47:	68 0f 09 00 00       	push   $0x90f
  4c:	68 1a 09 00 00       	push   $0x91a
  51:	6a 01                	push   $0x1
  53:	e8 48 05 00 00       	call   5a0 <printf>

        printf(1,"My old CID is %d\n", getcid() );
  58:	e8 6d 04 00 00       	call   4ca <getcid>
  5d:	83 c4 0c             	add    $0xc,%esp
  60:	50                   	push   %eax
  61:	68 1e 09 00 00       	push   $0x91e
  66:	6a 01                	push   $0x1
  68:	e8 33 05 00 00       	call   5a0 <printf>
        join_container(7);
  6d:	c7 04 24 07 00 00 00 	movl   $0x7,(%esp)
  74:	e8 41 04 00 00       	call   4ba <join_container>
        printf(1,"My new CID is %d\n", getcid() );
  79:	e8 4c 04 00 00       	call   4ca <getcid>
  7e:	83 c4 0c             	add    $0xc,%esp
  81:	50                   	push   %eax
  82:	68 30 09 00 00       	push   $0x930
  87:	6a 01                	push   $0x1
  89:	e8 12 05 00 00       	call   5a0 <printf>
        //CREATE
        // int fd = 
        // ps();
        printf(1,"%s\n","I am CONTAINERCHECK2" );
  8e:	83 c4 0c             	add    $0xc,%esp
  91:	68 42 09 00 00       	push   $0x942
  96:	68 1a 09 00 00       	push   $0x91a
  9b:	6a 01                	push   $0x1
  9d:	e8 fe 04 00 00       	call   5a0 <printf>
        // open("abc",512);
        // exit();
        open("new_file_2",512);
  a2:	58                   	pop    %eax
  ...
  ae:	e8 5f 03 00 00       	call   412 <open>
  ...
  b4:	5b                   	pop    %ebx
  b5:	6a 02                	push   $0x2
  b7:	68 57 09 00 00       	push   $0x957
  bc:	e8 51 03 00 00       	call   412 <open>
        // int fd2 = open("abc",2);
  ...
  cd:	50                   	push   %eax
  ce:	e8 1f 03 00 00       	call   3f2 <write>

        close(fd1);
  d3:	89 1c 24             	mov    %ebx,(%esp)
  d6:	e8 1f 03 00 00       	call   3fa <close>
        // close(fd2); 
        printf(1,"%s\n","Just before exec" );
  db:	83 c4 0c             	add    $0xc,%esp
  de:	68 6b 09 00 00       	push   $0x96b
  e3:	68 1a 09 00 00       	push   $0x91a
  e8:	6a 01                	push   $0x1
  ea:	e8 b1 04 00 00       	call   5a0 <printf>
        // exec("cat",argv_c);
        ...
        // exec("ls",argv_p);
        exit();
  ef:	e8 de 02 00 00       	call   3d2 <exit>
    }
        // exit();

    pid = fork();
  f4:	e8 d1 02 00 00       	call   3ca <fork>
    if (pid==0){
  f9:	85 c0                	test   %eax,%eax
  fb:	75 6a                	jne    167 <main+0x167>
 ...
 100:	6a 06                	push   $0x6
 102:	e8 b3 03 00 00       	call   4ba <join_container>
        // printf(1,"My new CID is %d\n", getcid() );
        //CREATE
        // int fd = 
        open("new_file_2",512);
 107:	58                   	pop    %eax
 108:	5a                   	pop    %edx
 109:	68 00 02 00 00       	push   $0x200
 10e:	68 57 09 00 00       	push   $0x957
 113:	e8 fa 02 00 00       	call   412 <open>
        open("new_file_4",512);
 118:	59                   	pop    %ecx
 119:	5b                   	pop    %ebx
 11a:	68 00 02 00 00       	push   $0x200
 11f:	68 7c 09 00 00       	push   $0x97c
 124:	e8 e9 02 00 00       	call   412 <open>
 ...
 12a:	5a                   	pop    %edx
 12b:	6a 02                	push   $0x2
 12d:	68 57 09 00 00       	push   $0x957
 132:	e8 db 02 00 00       	call   412 <open>
 ...
 13a:	89 c3                	mov    %eax,%ebx
        write(fd1,"banchhor",8);
 13c:	6a 08                	push   $0x8
 13e:	68 87 09 00 00       	push   $0x987
 143:	50                   	push   %eax
 144:	e8 a9 02 00 00       	call   3f2 <write>
        close(fd1);
 149:	89 1c 24             	mov    %ebx,(%esp)
 14c:	e8 a9 02 00 00       	call   3fa <close>
        // sleep(20000);
 ...
 151:	59                   	pop    %ecx
 152:	5b                   	pop    %ebx
 153:	68 48 0c 00 00       	push   $0xc48
 158:	68 90 09 00 00       	push   $0x990
 15d:	e8 a8 02 00 00       	call   40a <exec>
        // exec("ls",argv_p);

        exit();
 162:	e8 6b 02 00 00       	call   3d2 <exit>
    ...
    wait();
 167:	e8 6e 02 00 00       	call   3da <wait>
    wait();
 16c:	e8 69 02 00 00       	call   3da <wait>
    // wait();
    // exec("ls",argv_c);
    ...
    exit();
 171:	e8 5c 02 00 00       	call   3d2 <exit>
...
000004e2 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 4e2:	b8 25 00 00 00       	mov    $0x25,%eax
 4e7:	cd 40                	int    $0x40
 4e9:	c3                   	ret    

000004ea <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 4ea:	b8 24 00 00 00       	mov    $0x24,%eax
 4ef:	cd 40                	int    $0x40
 4f1:	c3                   	ret    
 ...
 509:	85 d2                	test   %edx,%edx
{
 ...
 537:	f7 f1                	div    %ecx
 539:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 754:	e9 8f fe ff ff       	jmp    5e8 <printf+0x48>
          s = "(null)";
 759:	bb 97 09 00 00       	mov    $0x997,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 771:	a1 54 0c 00 00       	mov    0xc54,%eax
{
 ...
 7ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 7af:	a3 54 0c 00 00       	mov    %eax,0xc54
}
 7b4:	5b                   	pop    %ebx
 7b5:	5e                   	pop    %esi
 7b6:	5f                   	pop    %edi
 ...
 7c6:	72 ce                	jb     796 <free+0x26>
{
 ...
 7e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ea:	a3 54 0c 00 00       	mov    %eax,0xc54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 15 54 0c 00 00    	mov    0xc54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 47                	jae    898 <malloc+0x98>
    ...
    if(p == freep)
 851:	39 05 54 0c 00 00    	cmp    %eax,0xc54
 ...
 876:	e8 f5 fe ff ff       	call   770 <free>
  return freep;
 87b:	8b 15 54 0c 00 00    	mov    0xc54,%edx
 ...
 8a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 8a7:	89 15 54 0c 00 00    	mov    %edx,0xc54
}
 ...
 8b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 54 0c 00 00 58 	movl   $0xc58,0xc54
 8c7:	0c 00 00 
 8ca:	c7 05 58 0c 00 00 58 	movl   $0xc58,0xc58
 8d1:	0c 00 00 
    base.s.size = 0;
 8d4:	b8 58 0c 00 00       	mov    $0xc58,%eax
 8d9:	c7 05 5c 0c 00 00 00 	movl   $0x0,0xc5c
 8e0:	00 00 00 
