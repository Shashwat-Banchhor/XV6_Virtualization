...
00000692 <scheduler_log_off>:
SYSCALL(scheduler_log_off)
 692:	b8 25 00 00 00       	mov    $0x25,%eax
 697:	cd 40                	int    $0x40
 699:	c3                   	ret    

0000069a <scheduler_log_on>:
SYSCALL(scheduler_log_on)
 69a:	b8 24 00 00 00       	mov    $0x24,%eax
 69f:	cd 40                	int    $0x40
 6a1:	c3                   	ret    
